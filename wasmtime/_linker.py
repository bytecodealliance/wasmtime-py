...
class Linker(Managed["ctypes._Pointer[_bindings.wasmtime_linker_t]"]):
    engine: Engine
    ...
    def __init__(self, engine: Engine):
        ...
        provided.
        """
        self._set_ptr(_bindings.wasmtime_linker_new(engine.ptr()))
        self.engine = engine

    def _delete(self, ptr: "ctypes._Pointer[_bindings.wasmtime_linker_t]") -> None:
        _bindings.wasmtime_linker_delete(ptr)
    ...
    def allow_shadowing(self, allow: bool) -> None:
        ...
        _bindings.wasmtime_linker_allow_shadowing(self.ptr(), allow)
    ...
    def define(self, store: Storelike, module: str, name: str, item: AsExtern) -> None:
        ...
        error = _bindings.wasmtime_linker_define(
            self.ptr(),
            store._context(),
            module_buf,
            len(module_bytes),
    ...
    def define_func(self, module: str, name: str, ty: FuncType, func: Callable[..., Any], access_caller: bool = False) -> None:
        ...
        error = _bindings.wasmtime_linker_define_func(
            self.ptr(),
            module_buf,
            len(module_bytes),
            name_buf,
    ...
    def define_instance(self, store: Storelike, name: str, instance: Instance) -> None:
        ...
        name_buf = ctypes.create_string_buffer(name_bytes)
        error = _bindings.wasmtime_linker_define_instance(self.ptr(),
                                                    store._context(),
                                                    name_buf,
                                                    len(name_bytes),
    ...
    def define_wasi(self) -> None:
        ...
        """
        error = _bindings.wasmtime_linker_define_wasi(self.ptr())
        if error:
            raise WasmtimeError._from_ptr(error)
    ...
    def define_module(self, store: Storelike, name: str, module: Module) -> None:
        ...
        name_bytes = name.encode('utf-8')
        name_buf = ctypes.create_string_buffer(name_bytes)
        error = _bindings.wasmtime_linker_module(self.ptr(), store._context(), name_buf, len(name_bytes), module.ptr())
        if error:
            raise WasmtimeError._from_ptr(error)
    ...
    def instantiate(self, store: Storelike, module: Module) -> Instance:
        ...
        """
        trap = ctypes.POINTER(_bindings.wasm_trap_t)()
        instance = _bindings.wasmtime_instance_t()
        with enter_wasm(store) as trap:
            error = _bindings.wasmtime_linker_instantiate(
    ...
    def get_default(self, store: Storelike, name: str) -> Func:
        ...
        name_bytes = name.encode('utf-8')
        name_buf = ctypes.create_string_buffer(name_bytes)
        func = _bindings.wasmtime_func_t()
        error = _bindings.wasmtime_linker_get_default(self.ptr(), store._context(),
    ...
    def get(self, store: Storelike, module: str, name: str) -> AsExtern:
        ...
        ok = _bindings.wasmtime_linker_get(self.ptr(), store._context(),
